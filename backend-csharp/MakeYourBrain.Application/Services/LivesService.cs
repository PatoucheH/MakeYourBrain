...
public class LivesService(IDbConnectionFactory db)
{
    ...
    {
        using var conn = db.CreateConnection();
        // get_user_lives wraps regenerate_lives and converts next_life_in interval â†’ next_life_in_seconds integer,
