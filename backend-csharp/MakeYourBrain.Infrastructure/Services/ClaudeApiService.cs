    ...
    ILogger<ClaudeApiService> logger)
{
    ...
    // â”€â”€ Private DTOs for Claude API response parsing â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        Guid? themeId, string? forcedConcept, string? forcedConceptFr)
    {
        ...
        // â”€â”€ Select theme â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        // â”€â”€ Used concepts â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        // â”€â”€ Choose concept â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        string conceptName;
        string conceptFr;
        ...
        // â”€â”€ Generate questions â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        var generated = await AskClaudeForQuestionsAsync(conceptName, themeName);

        // â”€â”€ Insert concept â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        // â”€â”€ Insert questions â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        int added = 0;
        ...
        string themeName, IList<string> usedConcepts)
    {
        var avoidList = usedConcepts.Count > 0
            ? "\nðŸš« CRITICAL - These concepts have ALREADY been covered:\n" +
        ...
        var prompt = $$"""
...

            {
              ...
              "concept_fr": "Nom du concept en franÃ§ais"
            }
            """;
    ...
    private async Task<IList<ClaudeQuestion>> AskClaudeForQuestionsAsync(string conceptName, string themeName)
    {
        var prompt = $$"""
            ...
            - EASY: Requires genuine knowledge of the concept, not just common sense. The answer should not be guessable by someone unfamiliar with "{{conceptName}}". Ask about well-known but specific facts. ({{EasyCount}} questions)
              âœ… Good example: "What is the main weapon used by Link in The Legend of Zelda?" (specific but known by fans)
              âŒ Bad example: "What color is the sky?" or "Who is the main character of Zelda?" (too trivial)
            ...
            - Before finalizing each question, verify: "Could someone with NO knowledge of {{conceptName}} guess this answer from the question alone?" â€” if YES, rewrite it
              ...
              "questions": [
                {
                  ...
                  "explanation_fr": "Explication dÃ©taillÃ©e en franÃ§ais (2-3 phrases)",
                  "difficulty": "easy",
                  "answers_en": [
                  ...
                  "answers_fr": [
                    {"text": "Mauvaise rÃ©ponse 1", "is_correct": false},
                    {"text": "Bonne rÃ©ponse", "is_correct": true},
                    {"text": "Mauvaise rÃ©ponse 2", "is_correct": false},
                    {"text": "Mauvaise rÃ©ponse 3", "is_correct": false}
                  ]
                }
              ]
            }
